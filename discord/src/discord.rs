...
pub enum GatewayEvent {
    ...
    ThreadListSync(disc_objects::ThreadListSyncEvent),
    ThreadMemberUpdate(disc_objects::ThreadMember),
    ThreadMembersUpdate(disc_objects::ThreadMembersUpdateEvent),
    GuildCreate(disc_objects::Guild),
    GuildUpdate(disc_objects::Guild),
    GuildDelete(disc_objects::UnavailableGuild),
    GuildBanAdd(disc_objects::GuildBanEvent),
    GuildBanRemove(disc_objects::GuildBanEvent),
    GuildEmojisUpdate(disc_objects::GuildEmojisUpdateEvent),
    GuildStickersUpdate(disc_objects::GuildStickersUpdateEvent),
    GuildIntegrationsUpdate(disc_objects::GuildIdEvent),
    GuildMemberAdd(disc_objects::GuildMember),
    GuildMemberRemove(disc_objects::GuildMemberRemoveEvent),
    GuildMemberUpdate(disc_objects::GuildMemberUpdateEvent),
    GuildMembersChunk(disc_objects::GuildMembersChunkEvent),
    GuildRoleCreate(disc_objects::GuildRoleEvent),
    GuildRoleUpdate(disc_objects::GuildRoleEvent),
    GuildRoleDelete(disc_objects::GuildRoleDeleteEvent),
    IntegrationCreate(disc_objects::Integration),
    IntegrationUpdate(disc_objects::Integration),
    IntegrationDelete(disc_objects::IntegrationDeleteEvent),
    InteractionCreate(disc_objects::Interaction),
